...
public class Fonction_Ajouter_Boisson_Alcool extends JPanel implements ActionListener{
	...
	public Fonction_Ajouter_Boisson_Alcool(){
		
		
		pProduit = new JPanel();
		pBoutonCommande = new JPanel();
		pPlat = new JPanel();
		titreNom = new JLabel("Nom de la boisson :");
		titrePrix = new JLabel("Prix de la boisson :");
	...
	public void actionPerformed(ActionEvent e) {
		if(e.getSource() == boutonCommande){
			...
			if(Modele.addCommandeBoissonAlcool(prixPlat, nomPlat, stockPlat)){
				JOptionPane.showMessageDialog(null, "La boisson alcoolisée a été ajouté avec succès " + "CHEF ", "flunch's information", JOptionPane.INFORMATION_MESSAGE);
