...
public class Fonction_Ajouter_Boisson_Soft extends JPanel implements ActionListener{
	...
	public Fonction_Ajouter_Boisson_Soft(){
	...
	public void actionPerformed(ActionEvent e) {
		if(e.getSource() == boutonCommande){
			...
			if(Modele.addCommandeBoissonSoft(prixPlat, nomPlat, stockPlat)){
				JOptionPane.showMessageDialog(null, "La boisson soft a été ajouté avec succès " + "CHEF ", "flunch's information", JOptionPane.INFORMATION_MESSAGE);
