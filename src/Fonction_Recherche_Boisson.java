...
public class Fonction_Recherche_Boisson extends JPanel implements ActionListener{
	...
	public Fonction_Recherche_Boisson(){
	...
	public void actionPerformed(ActionEvent e) {
		if(e.getSource() == boutonCommande){
			...
			if(Modele.searchCommandeBoisson(nomPlat)){
				JOptionPane.showMessageDialog(null, "La boisson a été trouvé avec succès " + "CHEF ", "flunch's information", JOptionPane.INFORMATION_MESSAGE);
