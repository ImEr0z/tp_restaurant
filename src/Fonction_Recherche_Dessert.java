...
public class Fonction_Recherche_Dessert extends JPanel implements ActionListener{
	...
	public Fonction_Recherche_Dessert(){
	...
	public void actionPerformed(ActionEvent e) {
		if(e.getSource() == boutonCommande){
			...
			if(Modele.searchCommandeDessert(nomPlat)){
				JOptionPane.showMessageDialog(null, "Le dessert a été trouvé avec succès " + "CHEF ", "flunch's information", JOptionPane.INFORMATION_MESSAGE);
