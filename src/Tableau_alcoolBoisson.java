...
public class Tableau_alcoolBoisson extends JPanel{
	...
	public Tableau_alcoolBoisson(ArrayList<alcoolBoisson> LesBoissonsAlcoolisees) {

		// Instanciation des panels
		this.panelLigne1 = new JPanel();
		this.titreProduit = new JLabel("Affichage des boissons alcoolisées présentes chez Flunch's");
		this.titreNbPlat = new JLabel("Nombre de boissons soft présentes : " + Modele.getNbBoissonAlcool());
		 ...
		 */
		int compteur = 0;
		Object[][]data = new Object[LesBoissonsAlcoolisees.size()][4];
		for(alcoolBoisson elt : Modele.getLesBoissonsAlcoolisees()) {
