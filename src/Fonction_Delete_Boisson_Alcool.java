...
public class Fonction_Delete_Boisson_Alcool extends JPanel implements ActionListener{
	...
	public Fonction_Delete_Boisson_Alcool(){
		 ...
		 */
		pPlat = new JPanel();
		titrePlat = new JLabel("Boisson alcoolisée à supprimer :");
		plat= new JComboBox();
		for(alcoolBoisson laboisson : Modele.getLesBoissonsAlcoolisees()){
	...
	public void actionPerformed(ActionEvent e) {
		if(e.getSource() == boutonCommande){
			...
			if(Modele.deleteCommandeDessert(sPlat)){
				JOptionPane.showMessageDialog(null, "La boisson alcoolisée a été supprimée avec succès " + "CHEF ", "flunch's information", JOptionPane.INFORMATION_MESSAGE);
