...
public class Fonction_ajout extends JPanel implements ActionListener{
	...
	public Fonction_ajout(){
		...
		titrePrix = new JLabel("Prix du plat :");
	...
	public void actionPerformed(ActionEvent e) {
		if(e.getSource() == boutonCommande){
			...
			if(Modele.addCommande(prixPlat, nomPlat, stockPlat)){
				JOptionPane.showMessageDialog(null, "Le plat a été ajouté avec succès " + "CHEF ", "flunch's information", JOptionPane.INFORMATION_MESSAGE);
