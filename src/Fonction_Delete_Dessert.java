...
public class Fonction_Delete_Dessert extends JPanel implements ActionListener{
	...
	public Fonction_Delete_Dessert(){
		 ...
		 */
		pPlat = new JPanel();
		titrePlat = new JLabel("Dessert à supprimer :");
		plat= new JComboBox();
		for(Dessert ledessert : Modele.getLesDesserts()){
			plat.addItem(ledessert.getNomDessert());
		}
	...
	public void actionPerformed(ActionEvent e) {
		if(e.getSource() == boutonCommande){
			...
			if(Modele.deleteCommandeDessert(sPlat)){
				JOptionPane.showMessageDialog(null, "Le dessert a été supprimé avec succès " + "CHEF ", "flunch's information", JOptionPane.INFORMATION_MESSAGE);
